...
#define R2AR        (3600.0/D2R)        /* radian to arc sec */
...
#endif
#define MAXRCV      640                 /* max receiver number (1 to MAXRCV) */
...
#define SOLQ_FIXDEG 8                   /* solution status: fix degenerate */
...
#define LCOPT_NOLC   0                  /* RTK linear combination option: no linear combination */
#define LCOPT_WLLC   1                  /* RTK linear combination option: WL */
#define LCOPT_TCAR   2                  /* RTK linear combination option: TCAR */
#define LCOPT_IFLC   3                  /* RTK linear combination option: iono-free */
#define LCOPT_NLLC   4                  /* RTK linear combination option: NL */
#define LCOPT_TCLC   5                  /* RTK linear combination option: TL */
#define LCOPT_SPLC   6                  /* RTK linear combination option: given freqs and coeffs */
...
#define ARMODE_PRESET  4                /* AR mode: preset */
...
typedef struct {        /* solution type */
    ...
    double dtrr;        /* receiver clock bias drift (m/s) */
    ...
    uint8_t nb;         /* number of valid ambiguity */
...
typedef struct {        /* solution options type */
    ...
    int tracelevel;     /* debug trace level (0:off,1-5:debug) */
...
typedef struct {         /* satellite status type */
    ...
    int8_t vsat[NFREQ];  /* valid satellite flag */
    uint16_t snr[NFREQ]; /* signal strength (*SNR_UNIT dBHz) */
    uint8_t fix [NFREQ]; /* ambiguity fix flag (0:init,1:float,2:fix,3:hold,5:ambiguity closure) */
...
extern const prcopt_t prcopt_default_ppp;
